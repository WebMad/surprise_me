...
abstract class $ChatCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, List<User> members});
}
...
class _$_Chat implements _Chat {
  const _$_Chat({required this.id, required final List<User> members})
      : _members = members;
...
abstract class _Chat implements Chat {
  const factory _Chat(
      {required final String id, required final List<User> members}) = _$_Chat;
